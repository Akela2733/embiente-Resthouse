...
const Stay = () => {
  return (
    <section
      id="stay"
      className="bg-[#f4f0e8] px-6 py-5 text-stone-800 sm:px-12 lg:px-16 lg:py-5"
    >
      <div className="mx-auto max-w-7xl space-y-5 lg:space-y-10">
        <div className="grid gap-12 lg:grid-cols-[0.8fr_2.2fr] lg:gap-16">
          ...
          <div className="grid gap-5 sm:grid-cols-3 sm:gap-2 lg:gap-3">
            {rooms.map((room) => (
